 ...
 * Tests cover most operations that are possible with GenericQueue using the Integer class.
 *
 */
@DisplayName("Testing GenericQueue implementation using Integer objects")
class GenericQueueIntegerTest {
    final int SIZE_1 = 5;
    final int SIZE_2 = 0;
    GenericQueue<Integer> queue1;
    GenericQueue<Integer> queue2;
    final Integer FIRST = 1;
    final Integer SECOND = 2;
    final Integer THIRD = 3;
    final Integer FOURTH = 4;
    final Integer FIFTH = 5;
    ...
    void setup(){
        ...
        queue1 = new GenericQueue<Integer>(SIZE_1);
        queue2 = new GenericQueue<Integer>(SIZE_2);
    }
